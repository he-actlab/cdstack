# Generated from /Users/seankinzer/ACTLab/cmlang/cmlang.code/cmstack/CMLang/CMLang.g4 by ANTLR 4.7.2
import inspect
from collections import deque

from antlr4 import *
from cmstack.cmlang.antlr_generator.graphutils import *
from cmstack.cmlang.antlr_generator.parser import CMLangParser
from cmstack.hdfg import cmlang_hdfg
import cmstack.cmlang.antlr_generator.loopy_utils as lu
import loopy as lp
...
class CMLangListener(ParseTreeListener):
    ...
    def exitCmlang(self, ctx:CMLangParser.CmlangContext):
        ...
        self.program = cmlang_hdfg.create_hdfg(self.components, self.graph)
    ...
    def exitComponent_definition(self, ctx:CMLangParser.Component_definitionContext):
        ...
        #     knl = lu.create_loop_kernel(scope, self.domains, self.instructions, self.edges, self.signature)
        del self.inputs
        del self.states
        del self.outputs
        del self.params
