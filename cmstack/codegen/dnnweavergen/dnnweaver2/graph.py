...
from cmstack.codegen.dnnweavergen.dnnweaver2.scalar.dtypes import Dtype, FQDtype, FixedPoint, Log, Binary, Float, CustomFloat
from cmstack.codegen.dnnweavergen.dnnweaver2.utils.utils import lookup_pandas_dataframe
...
class Graph(object):
    ...
    def benchmark_tf(self, phase='forward+backward', csv_file='gpu_baseline.csv'):
        ...
        if len(r) == 0:
            ...
            from cmstack.codegen.dnnweavergen.dnnweaver2.tf_utils import get_tf_performance
