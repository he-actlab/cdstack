...
from cmstack.hdfg.passes.flatten import flatten_graph, is_literal, is_number
from cmstack.hdfg.passes.node_mapping import map_nodes
from cmstack.codegen.codegen_utils import CMLANG_CAST_MAP, get_func

from cmstack.hdfg.hdfg_pb2 import Component, Program
from cmstack.hdfg.visualize import *
import json
import logging
...
class Translator(object):
    ...
    def __init__(self, onnx_proto, config_path, passes, run_async=False):
